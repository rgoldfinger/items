    ...
    return (
      <div>
        <div style={{backgroundImage: 'url(img/banner.jpg)', height: '500px', backgroundSize: '100%'}} className="poster">
          <div className="item-container horizontal-box align-items-spacearound">
            <div className="align-self-start flex-1">
              <h1 className="light-text banner-text">University of Edinburgh</h1>
            ...
            <div style={{textAlign: 'right'}} className="align-self-end flex-1">
              <h1 className="light-text banner-text">Conditions on the early earth</h1>
        ...
        <div className="item-container horizontal-box align-items-center">
          <h1 className="light-text">Conditions of Early Life on Earth</h1>
        </div>

        <div className="item-container">
          <div style={{backgroundColor: bgc}} className="text-box light-text serif">
        ...
        <div style={{backgroundImage: 'url(img/greenland_isua.jpg)', height: '800px', backgroundSize: '100%'}}>
          <div className="horizontal-box align-items-spacebetween item-container">
            <div style={{backgroundColor: bgcOp}} className="text-box light-text align-self-end serif">
              <div>These rocks are very altered, but nevertheless, we can tell something about them, and what the conditions might have been like, on early earth. And if we look at those Isua rocks, we find evidence of a number of different types of rocks that might have existed in those original ancient sediments. </div>
            </div>
            <div className="align-self-start text-box light-text serif">Some of the oldest rocks are from the Isua region, of western Greenland. And these are rocks that were made up of ancient sediments on early earth, about 3.8 billion years ago. And they've subsequently been pressurized and heated, over the many billions of years, in which those rocks have been subducted into the crust of the earth and then re-exposed. </div>
          </div>
        </div>
        ...
        <div style={{backgroundImage: 'url(img/limestone_coast.jpg)', height: '900px', backgroundSize: '100%'}}>
          <div className="item-container">
            <div style={{backgroundColor: bgcOp}} className="text-box light-text serif">
        ...
        <div className="item-container horizontal-box align-items-center">
          <div className="text-box light-text serif">
        ...
        <div style={{backgroundImage: 'url(img/earth_cutaway.jpg)', height: '800px', backgroundSize: '100%'}} >
          <div className="item-container">
            <div style={{backgroundColor: bgcOp}} className="text-box light-text serif">
              <div>This suggests that the Earth also had internal layering. A differentiation of the different parts of the earth from the core, through the mantle, through to the crust. It suggests that the structure of the earth is much like present day earth. So, at least in terms of the presence of liquid water, the presence of land masses, the earth might have been somewhat similar to present day earth about 3.8 billion years ago. The sort of environment that we think might have been condusive to life. </div>
            </div>
          </div>
        </div>
        ...
        <div className="item-container horizontal-box align-items-center">
          <h1 className="light-text">What about the other characteristics of the planet that are important for biology? </h1>
        </div>

        <div className="item-container horizontal-box align-items-center">
          <div style={{backgroundColor: bgc}} className="text-box light-text serif">
            <div>We can learn something about the early atmosphere, and we'll talk about Oxygen in the atmosphere later on in this course. </div>
          </div>
        </div>
        ...
        <div className="item-container horizontal-box align-items-center">
          <h1 className="light-text">What would that have meant for early life forms?</h1>
        </div>
